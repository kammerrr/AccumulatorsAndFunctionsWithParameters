...
def draw_circles1():
    ...
    print('--------------------------------------------------')
    winner = rg.RoseWindow(400, 400)
    for k in range(21):
        cir = rg.Circle(rg.Point(200, 200), k * 10)
        cir.attach_to(winner)
        winner.render(.5)
    winner.close_on_mouse_click()
...
def draw_circles2():
    ...
    print('--------------------------------------------------')
    winner2 = rg.RoseWindow(400, 400)
    total = 30
    for k in range(18):
        total = total + 20
        cir2 = rg.Circle(rg.Point(total, 100), 10)
        cir2.attach_to(winner2)
        cir2.outline_color = 'blue'
        winner2.render(.5)
    winner2.close_on_mouse_click()
...
def draw_circles3():
    ...
    print('--------------------------------------------------')
    winner3 = rg.RoseWindow(300, 300)
    total = 1
    for k in range(99):
        total = total + 1
        cir3 = rg.Circle(rg.Point(200, 150), total)
        cir3.attach_to(winner3)
        cir3.outline_color = 'blue'
        winner3.render()
    winner3.close_on_mouse_click()
...
def draw_cosines_and_sines():
    ...
    print('--------------------------------------------------')
    winner4 = rg.RoseWindow(400)
    for k in range(100):
        cir4 = rg.Circle(rg.Point(200 + (80 * ma.cos(k)), 200 + (80*ma.sin(k))), 10)
        cir4.attach_to(winner4)
        winner4.render()
    winner4.close_on_mouse_click()
# ----------------------------------------------------------------------
