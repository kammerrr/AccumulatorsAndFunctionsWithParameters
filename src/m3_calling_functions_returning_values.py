...
def test_digits_in_power():
    ...
    # test 1
    expected = 1
    real = digits_in_power(10, 2)
    print('Test 2 expected: ', expected)
    print('actual: ', real)

    # test 2
    expected = 10
    real = digits_in_power(4, 3)
    print('Test 2 expected: ', expected)
    print('actual: ', real)

    # test 3
    expected = 11
    real = digits_in_power(5, 5)
...
def test_fancy_sums_of_digits():
    ...
    expected = 19084
    real = fancy_sums_of_digits(2)
    print('Test 1 expected: ', expected)
    print('actual: ', real)

    expected = 124309
    real = fancy_sums_of_digits(35)
    print('Test 2 expected: ', expected)
    print('actual: ', real)
    # ------------------------------------------------------------------
